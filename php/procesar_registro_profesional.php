...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // Insertar usuario
        $stmt = $pdo->prepare("
            INSERT INTO profesional (nombre, especialidad, email, telefono, fecha_nacimiento, password)
            VALUES (:nombre, :especialidad, :email, :telefono, :fecha_nacimiento, :password)
            RETURNING id
        ");
